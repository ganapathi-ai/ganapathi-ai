...
|--------|-------------|--------|-------------|
| **PGDM** - AI & Data Science (Healthcare) | Institute of Health Management & Research (IIHMR), Bangalore | Expected: June 2027 | - |
| **B.Sc** - Cardiac Care & Cardiovascular Technology | Dr. NTR University of Health Sciences, Vijayawada | Completed: April 2025 | 70.14% |
| **Intermediate** | Sri Chaitanya Junior Co-Ed College, Vijayawada | Completed: March 2018 | 96.6% |
| **10th Class** | Andhra Pradesh Residential School | Completed: March 2016 | 92.15% |
...
![Image Segmentation](https://img.shields.io/badge/Image%20Segmentation-FF6F00?style=for-the-badge)
![Survival Analysis](https://img.shields.io/badge/Survival%20Analysis-FF6F00?style=for-the-badge)
![Time Series](https://img.shields.io/badge/Time%20Series-FF6F00?style=for-the-badge)

### 🤖 AI & Generative AI
![LLM](https://img.shields.io/badge/LLM-10A37F?style=for-the-badge)
![RAG](https://img.shields.io/badge/RAG-10A37F?style=for-the-badge)
![LangChain](https://img.shields.io/badge/LangChain-10A37F?style=for-the-badge)
![LLamaIndex](https://img.shields.io/badge/LLamaIndex-10A37F?style=for-the-badge)
![Vector Databases](https://img.shields.io/badge/Vector%20DB-10A37F?style=for-the-badge)
![Hugging Face](https://img.shields.io/badge/Hugging%20Face-10A37F?style=for-the-badge&logo=huggingface&logoColor=white)
...
|---------|-------------|-----------|
| **Care Transition Analytics** | End-to-end analytics for UAC reunification pipeline, multi-stage process analysis for DHHS | Python • Streamlit • Power BI • EDA |
| **Diabetic Foot Ulcer Segmentation** | CNN-based image segmentation using ResNet34 and U-Net architecture | Deep Learning • ResNet34 • U-Net |
| **Heart Attack Risk Analysis** | Interactive Tableau dashboard for clinical risk profiling | Tableau • Clinical Data Visualization |
| **Fetal Health Classification** | ML model for CTG data classification with Streamlit deployment | Machine Learning • Streamlit • Clinical AI |
| **Survival Analysis - VAP Prevention** | Clinical trial analytics using Kaplan–Meier and Cox regression | Python • Survival Analysis • Statistics |
| **EchoLens - AI Echocardiography** | AI-assisted reporting system aligned with ASE guidelines | Healthcare AI • UX Research |
...
|---------|-------------|-----------|
| **Product Optimization - Revenue Analysis** | Advanced portfolio analysis for revenue optimization | [View Repo](https://github.com/ganapathi-ai/Product_Optimization_-_Revenue_Contribution_Analysis) |
| **APL Logistics Profitability Intelligence** | Supply chain optimization and cost reduction analytics | [View Repo](https://github.com/ganapathi-ai/APL_Logistics_Profitability_Intelligence-) |
...
| Project | Description | Repository |
|---------|-------------|-----------|
| **VerbLume** | AI-powered adaptive language learning platform | [View Repo](https://github.com/ganapathi-ai/VerbLume) |
| **LinkedIn Content Engine** | NLP-based content optimization for engagement | [View Repo](https://github.com/ganapathi-ai/LinkedIn-Content-Engine-) |
| **Dentoverse** | Comprehensive dental practice management platform | [View Repo](https://github.com/ganapathi-ai/dentoverse) |
...
🎯 **Conference Volunteer** - 21st International Conference of the Telemedicine Society of India, Bangalore (November 2025)

🎓 **Student Volunteer** - Digital Health Exemplars Dissemination Seminar, IIHMR Bangalore (December 2025)

🚀 **Bengaluru Tech Summit 2025** - Exposure to emerging technology trends

💼 **Futuristic Leadership Summit 2025** - Bangalore Management Association (October 2025)

### 🌐 Languages
**English** (Professional) • **Telugu** (Fluent) • **Hindi** (Beginner Proficiency)
